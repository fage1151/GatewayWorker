作为一款16年就已经正式推出的商业组件，过去的一年多时间里LayIM都并没有开放下载。为了给更多的开发者带来一些社交想象，LayIM于6月9号正式开源V2版本，你可以自由下载和使用。LayIM是网页即时通讯（WebIM）前端解决方案，致力于通过灵活、丰富的前端交互，及高度开放的接口，让其自由接入到你的Web系统，从而打造一套属于自己的网页即时聊天系统。
